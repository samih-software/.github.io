...
I'm a software engineer passionate about web development, cloud systems, and AI-driven solutions.  
...
### **E-commerce Platform for Fish Distributor** (Dec 2025 – Present) – Personal Project
- Developed a RESTful backend using **Java, Spring Boot, Hibernate, and MySQL** with JWT authentication and **Stripe payment integration**.  
- Built a **React.js frontend** and connected a proprietary delivery service via **Open Source Routing Machine & Nominatim** using Docker.  
